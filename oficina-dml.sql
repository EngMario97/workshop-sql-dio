...
-- Veiculo
insert into veiculo (idVCliente,Tipo_veiculo,Placa,Marca,Modelo,Ano_fabricacao) 
	values ('1','Carro','QWE1234','Fiat','Uno','2010'),
...
-- Estoque_pecas
insert into estoque_pecas (Nome_peca,Quantidade_disponivel,Valor_unitario,Responsavel,Funcionario_solicitante) 
	values ('Pastilhas de freio','62','20.00','Pedro Castro','Pedro Castro'),
			('pneu','5','319.90','João Silva','Pedro Castro'),
			('fusivel','13','60.59','Pedro Castro','João Silva'),
			('bateria','40','120.20','João Silva','Pedro Castro');
			
-- Tabela_precos
insert into tabela_precos (Tipo_servico,Especialidade,Pecas_nescessarias,Quantidade_pecas,Preco_peca,Valor_mao_obra,Valor_total) 
	values ('manutenção preventiva','Mecânica','Pastilhas de freio',null,null,'100.00','80.00'),
			('manutenção preventiva','Mecânica','Troca de pneus',null,null,'100.00','2000.00'),
			('manutenção corretiva','Parte Elétrica','Troca de Fusiveis',null,null,'100.00','50.00'),
			('manutenção corretiva','Parte Elétrica','bateria',null,null,'100.00','250.00');
        
-- Equipes
insert into equipes (idEquipes,Especialidade,Responsavel) 
	values ('1','Parte Elétrica','Pedro Castro'),
...
insert into funcionarios (idFEquipes,Codigo_funcionario,Nome,CPF,Data_nacimento ,Endereco,CEP,Cidade,Estado,Cargo,Especialidade,Data_contratacao,Telefone)
		values ('1','1','Pedro Castro','12345678911','1980-01-01','Rua 5','30672772','Belo Horizonte','MG','Chefe Mecânica','Mecânica automotiva','2020-04-21','31912222222'),
				('2','2','João Silva','09875647821','1990-02-02','Rua 5','30672772','Belo Horizonte','MG','Mecânico','Mecânica automotiva','2015-12-15','31985487485'),
				('1','3','Antônio Jose','11146987562','1991-03-03','Rua 5','830672772','Belo Horizonte','MG','Eletricista Mecânico','Elétrica automotiva','2018-03-13','319322222'),
				('2','4','Ronaldo Ferreira','09873547894','1992-04-04','Rua 5','30672772','Belo Horizonte','MG','Eletricista Mecânico','Elétrica automotiva','2019-06-18','3192444444');
				

-- Orcamento
insert into orcamento (idOCliente,Numero_orcamento,Aprovado_cliente,Data_orcamento,Valor_orcamento,Validade_orcamento) 
	values ('1','10000000','Sim','2022-01-01','300.00','2020-01-16'),
			('2','10000007','Sim','2022-01-12','600.00','2022-01-12'),
			('3','10000008','Sim','2022-02-02','500.00','2022-02-02'),
			('4','10000009','Sim','2022-02-03','400.00','2022-02-03'),
			('5','10000011','Sim','2022-02-05','300.00','2022-02-05'),
			('6','10000012','Sim','2022-04-10','2000.00','2022-04-10'),
			('7','10000025','Sim','2022-05-14','500.00','2022-05-14'),
			('8','10000030','Sim','2022-01-02','200.00','2022-01-02'),
			('9','10000032','Sim','2022-03-10','100.00','2022-03-10');
...
insert into ordem_servico (idOSVeiculo,idOSEquipes,idOSOrcamento,Numero,Data_emissao,pecas_necessarias,Valor,Status_ordem,Data_conclusao) values
		...
		('2','2','2','10000007','2022-09-08','bateria','500.00','Serviço iniciado',null),
		('1','1','3','10000008','2022-03-07','pastilhas de freito','300.00','Serviço iniciado',null),
		('2','2','4','10000009','2022-02-01','motor de arranque','900.00','Serviço iniciado',null),
		('2','2','5','10000011','2022-09-13','filtro de combustivel','150.00','Serviço concluido','2022-09-13'),
		('1','1','6','10000012','2022-04-24','velas','200.00','Serviço iniciado',null),
		('2','2','7','10000025','2022-01-12','puxador porta malas','50.00','Serviço concluido','2022-01-12'),
		('2','2','8','10000030','2022-05-21','fluido de freio','80.00','Serviço iniciado',null),
		('1','1','9','10000032','2022-05-06','alinhamento','120.00','Serviço concluido','2022-05-06');